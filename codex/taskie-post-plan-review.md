---
description: Address plan review comments
...
# Implement Post-Plan-Review Fixes

Address the issues surfaced by the latest plan review in `.taskie/plans/{current-plan-dir}/plan-{latest-review-id}.md`
...
After you're done with your changes, update the plan file and document your changes.
