...
Perform a thorough review of the task list in `.taskie/plans/{current-plan-dir}/tasks.md` and all task files. Be very critical, look for mistakes, inconsistencies, misunderstandings, gaps in the task breakdown, over-engineering and other cruft.
...
Document the results of your review in `.taskie/plans/{current-plan-dir}/tasks-review-{review-id}.md`.
