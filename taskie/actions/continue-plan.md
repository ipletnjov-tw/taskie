...
Carefully read the `.llm/ground-rules.md` for extra context & further instructions. Figure out where you left off and continue from there: find the last changed task(s) from the task list, check the subtasks and reviews for each task. You may also use git history for more information.
