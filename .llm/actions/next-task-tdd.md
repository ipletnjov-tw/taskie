...
After you're done, document your progress in `.llm/plans/{current-plan-dir}/task-{next-task-id}.md` and update the status and git commit hash. Update the task status in `.llm/plans/{current-plan-dir}/tasks.md`.
