...
# This script installs Taskie prompts to ~/.codex/prompts/taskie/

set -e

CODEX_PROMPTS_DIR="${CODEX_HOME:-$HOME/.codex}/prompts/taskie"
...
echo ""
echo "For usage instructions, see CODEX.md"
