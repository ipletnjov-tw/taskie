...
echo ""
echo "Installed 19 files:"
echo "  - 18 user-invocable prompts (taskie-new-plan, taskie-continue-plan, etc.)"
...
echo "  /prompts:taskie-code-review-conventions - Code review focused on conventions"
